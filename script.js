...
const updateProgressBar = () => {
  ...
  time = Math.floor((Math.round(videoViewer.currentTime) *100) / Math.round(videoViewer.duration));
...
const updateSeek = (e) => {
  skipTo = Math.round((e.offsetX / e.target.clientWidth) * parseInt(e.target.getAttribute('max'), 10));
